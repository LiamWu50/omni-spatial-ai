      ...
      <div
        ...
        className={cn(
          ...
          variant === 'floating' || variant === 'inset'
            ...
            : 'group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=left]:border-sidebar-border group-data-[side=right]:border-l-sidebar-border',
          className
        )}
        {...props}
      >
...
function SidebarTrigger({ className, onClick, children, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <ChevronsRight className={cn(open && 'rotate-180')} />}
