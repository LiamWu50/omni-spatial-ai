...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "data-[placeholder]:text-text-disabled [&_svg:not([class*='text-'])]:text-text-secondary focus-visible:border-border-strong focus-visible:ring-brand-green/50 aria-invalid:ring-text-negative/20 aria-invalid:border-text-negative bg-card flex w-fit items-center justify-between gap-2 rounded-[6px] border border-border px-3 py-2 text-sm whitespace-nowrap transition-[color,box-shadow] outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 data-[size=default]:h-9 data-[size=sm]:h-8 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 hover:bg-surface-hover",
        className
      )}
      {...props}
    >
