...
function ToolFallbackError({
  ...
  return (
    <div data-slot='tool-fallback-error' className={cn('aui-tool-fallback-error px-4', className)} {...props}>
      ...
      <p className='aui-tool-fallback-error-reason text-neutral-500 dark:text-neutral-400'>{errorText}</p>
    </div>
  )
}
...
const ToolFallbackImpl: ToolCallMessagePartComponent = ({ toolName, argsText, result, status }) => {
  ...
  return (
    <ToolFallbackRoot
      className={cn(
        'mb-2',
        isCancelled && 'border-neutral-500/30 bg-neutral-100/30 dark:border-neutral-400/30 dark:bg-neutral-800/30'
      )}
    >
