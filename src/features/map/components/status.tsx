...
export function Status({ state }: MapStatusProps) {
  return (
    <footer className='absolute inset-x-0 bottom-0 z-20 flex h-8 items-center justify-between border-t border-neutral-200 bg-white/90 px-4 text-[10px] leading-none text-neutral-600 backdrop-blur-xl dark:border-neutral-800 dark:bg-neutral-950/90 dark:text-neutral-300'>
      <div className='flex items-center gap-2 text-[10px] text-neutral-500 dark:text-neutral-400'>
        ...
        <span className='h-1 w-1 rounded-full bg-neutral-400 dark:bg-neutral-300' />
